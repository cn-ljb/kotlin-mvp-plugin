...
public class ActionAutoKt extends AnAction {
    ...
    private void createMvpAppCompatActivity() {
        ...
        //创建Contract
        InputStream tContractInput = this.getClass().getResourceAsStream("/com/ljb/mvp/plugin/template/kt/TContractKt.txt");
    ...
    private void createMvpActivity() {
        String appPath = getAppPath();
        //创建Act
        InputStream tMvpActInput = this.getClass().getResourceAsStream("/com/ljb/mvp/plugin/template/kt/TMvpActivityKt.txt");
        String tActContent = FileUtils.readTemplateFile(tMvpActInput);
        String actDir = appPath + "/act";
        String actFileName = moduleName + "Activity.kt";
